...
engine = create_engine('postgresql://catalog:grader@localhost/catalog_db')
...
def gconnect():
    ...
    try:
        ...
        oauth_flow = flow_from_clientsecrets(ROOT + '/client_secrets.json', scope='')
...
# JSON API to view Restaurant Menu
